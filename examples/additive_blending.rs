...
fn animate_shapes(
    ...
    mut alpha_query: Query<&mut Transform, (With<AlphaBlendedShape>, Without<AdditiveBlendedShape>)>,
    mut additive_query: Query<&mut Transform, (With<AdditiveBlendedShape>, Without<AlphaBlendedShape>)>,
) {
